        ...
        assert_eq!(
            ...
            vec![
                Block::RichText(RichTextBlock { elements: vec![
                    BlockElement::RichTextSection(RichTextSectionElement {
                        elements: vec![
                            BlockElement::Text(TextBody { text: "Woohay! Nice one ".to_string() }),
                            BlockElement::User(UserElement { id: "U2M31DUM6".to_string() }),
                            BlockElement::Text(TextBody { text: " sam++".to_string() })
                        ]
                    })
                ]})
            ]
